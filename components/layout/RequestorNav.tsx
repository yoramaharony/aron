                        ...
                        >
                            {sidebarCollapsed ? (
                                ...
                                <div className="min-w-0">
                                    <div className="text-xs font-light tracking-wide text-[var(--color-gold)]">Organization</div>
                                    <div className="text-xs font-light text-[rgba(var(--silver-rgb),0.95)]">Portal</div>
                                </div>
                            )}
                        </div>
                    </div>
