      ...
      <div className="w-full flex items-center justify-end">
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="w-10 h-10 rounded-full bg-[rgba(255,255,255,0.06)] text-[var(--text-primary)] flex items-center justify-center text-xs font-semibold border border-[rgba(255,255,255,0.12)] hover:bg-[rgba(255,255,255,0.10)] transition-colors shadow-[0_12px_40px_-30px_rgba(0,0,0,0.85)]"
            aria-haspopup="menu"
