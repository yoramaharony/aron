  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 space-y-5">
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={[
                        ...
                        deliveryMethod === 'email'
                          ? 'bg-[rgba(var(--accent-rgb), 0.14)] border-[rgba(var(--accent-rgb), 0.35)] text-[rgba(var(--accent-rgb), 0.95)]'
        ...
        {createdCode ? (
          <div className="rounded-xl border border-[rgba(var(--accent-rgb), 0.22)] bg-[linear-gradient(180deg,rgba(var(--accent-rgb), 0.10),rgba(255,255,255,0.02))] p-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span
                        className={[
                          ...
                          stateLabel === 'active'
                            ? 'text-[var(--text-primary)] border-[rgba(var(--accent-rgb), 0.25)] bg-[rgba(var(--accent-rgb), 0.10)]'
                            : stateLabel === 'used'
